   ...
   if(handle != INVALID_HANDLE)
     {
      ...
      FileClose(handle);
      Print("Nautilus V2.11: ", ArraySize(robot_limits), " Limites de Robôs carregados com sucesso do arquivo: ", InpLimitsFile);
     }
   else
     {
      Print("Nautilus V2.11 Aviso: Arquivo '", InpLimitsFile, "' não encontrado na pasta MQL5\\Files. Nenhuma restrição do Eixo 2 ativa.");
     }
  }
...
void UpdateUI()
  {
   ...
   CreateLabel(pref+"Tit", head_x+25, y0, "Supervision Nautilus v2.11", InpClrProfit, font_xxl);
