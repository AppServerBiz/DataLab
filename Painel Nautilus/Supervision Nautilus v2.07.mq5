   ...
   if(handle != INVALID_HANDLE)
     {
      ...
      FileClose(handle);
      Print("Nautilus V2.07: ", ArraySize(robot_limits), " Limites de Robôs carregados do arquivo: ", InpLimitsFile);
     }
   else
     {
      Print("Nautilus V2.07 Aviso: Arquivo '", InpLimitsFile, "' não encontrado na pasta MQL5\\Files. Crie o arquivo baseado no modelo fornecido.");
     }
  }
...
void UpdateUI()
  {
   ...
   CreateLabel(pref+"Tit", head_x+25, y0, "Supervision Nautilus v2.07", InpClrProfit, font_xxl);
