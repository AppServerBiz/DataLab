...
const riskColor = (val: number) => {
  ...
  if (v > 15) return 'rgba(239, 68, 68, 0.7)'; // Red
  if (v > 5) return 'rgba(245, 158, 11, 0.5)';  // Amber
  if (v > 0) return 'rgba(245, 158, 11, 0.2)';  // Light Amber
  if (v < -5) return 'rgba(34, 197, 94, 0.5)'; // Dark Green
  if (v < 0) return 'rgba(34, 197, 94, 0.2)';  // Light Green
  return 'rgba(148, 163, 184, 0.2)';             // Gray
};
const riskTextColor = (val: number) => {
  const v = Number(val);
  if (isNaN(v)) return '#94A3B8';
  if (v > 15 || v < -5) return '#fff';
  return '#94A3B8';
};
...
const covColor = (val: number, maxVal: number) => {
  ...
  if (isNaN(v) || isNaN(m) || m === 0) return 'rgba(148, 163, 184, 0.2)';
